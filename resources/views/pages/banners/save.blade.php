          ...
          <div class="rounded shadow-lg p-4 px-4 ">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-3">
                <label for="title_btn">Texto para boton</label>
                <div class="relative mb-2  mt-2">
                  <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg"
                      version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0"
              ...
              <div class="md:col-span-2">
                <label for="url_btn">Url de boton</label>
                <div class="relative mb-2  mt-2">
                  <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg"
                      version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0"
              ...
              <div class="md:col-span-3">
                ...
                <div class="relative mb-2  mt-2">
                  <select
                    class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="url_page" id="url_page">
                    <option value="">Elige una pagina</option>
                    {{-- <option value="top" @if ($banners->potition == 'top') selected @endif>Superior</option> --}}
                    <option value="home" @if ($banners->url_page == 'home') selected @endif>Inicio</option>
                    <option value="catalogo" @if ($banners->url_page == 'catalogo') selected @endif>Catalogo</option>
